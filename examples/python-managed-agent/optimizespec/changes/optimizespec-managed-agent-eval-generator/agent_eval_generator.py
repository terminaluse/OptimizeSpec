...
DEFAULT_FIXTURE = ROOT / "optimizespec" / "fixtures" / "agents" / "optimizespec-managed-agent" / "agent.yaml"
MUTABLE_FIELDS = [
...
Use ManagedAgentRuntime from src/optimizespec/runtime.py, ManagedAgentEvaluator from src/optimizespec/evaluator.py, and optimize_demo from src/optimizespec/optimizer.py.
...
def cmd_optimize(
    ...
    result = optimize_candidate(
        ...
        run_dir=Path(run_dir),
        objective=(
            "Improve guidance for generating eval and optimizer artifacts for the existing optimizespec "
