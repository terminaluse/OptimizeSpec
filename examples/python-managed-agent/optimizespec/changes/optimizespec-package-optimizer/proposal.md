...
- Invocation: `python optimizespec/changes/optimizespec-package-optimizer/package_optimizer.py <command>`
...
Optimize the text guidance a package-maintenance agent uses when explaining and operating this `optimizespec` package. The optimized candidate should help an agent explain the package purpose, GEPA boundary, eval workflow, rollout lifecycle, ASI requirements, commands, verification, and v1 runtime limits accurately.
