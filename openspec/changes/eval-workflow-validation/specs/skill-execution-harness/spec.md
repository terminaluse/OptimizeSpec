...
### Requirement: Harness invokes the OptimizeSpec workflow against fixtures
The system SHALL provide a validation harness that runs the OptimizeSpec skill workflow against fixture agent inputs and records the generated artifacts and command evidence.
